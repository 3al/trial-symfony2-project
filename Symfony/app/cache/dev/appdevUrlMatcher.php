...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Acme\\TestBundle\\Controller\\TestController::indexAction',  '_route' => '_test',);
        }
        ...
        if (rtrim($pathinfo, '/') === '/admin') {
            ...
            return array (  '_controller' => 'Acme\\TestBundle\\Controller\\AdminController::indexAction',  '_route' => '_admin',);
        }

        // admin_login
        if ($pathinfo === '/admin/login') {
            return array (  '_controller' => 'Acme\\SecurityBundle\\Controller\\SecurityController::loginAction',  '_route' => 'admin_login',);
        }
